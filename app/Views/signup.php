    ...
    <div class="w-full max-w-xl relative z-10">
        ...
        <div class="bg-card dark:bg-[#111827]/80 backdrop-blur-xl rounded-[2.5rem] p-8 sm:p-12 shadow-2xl border border-borderBase relative overflow-hidden">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-black text-textMain tracking-tight mb-2"><?= lang('App.signup_create_account') ?></h1>
                <p class="text-textMuted font-medium"><?= lang('App.signup_join_community') ?></p>
            </div>
            ...
            <form action="#" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-sm font-bold text-textMain"><?= lang('App.signup_first_name') ?></label>
                    ...
                    <!-- Last Name -->
                    <div class="space-y-1.5">
                        <label class="block text-sm font-bold text-textMain"><?= lang('App.signup_last_name') ?></label>
                ...
                <div x-show="role === 'business'" x-collapse>
                    <div class="space-y-1.5 pb-2">
                        <label class="block text-sm font-bold text-textMain"><?= lang('App.signup_business_name') ?></label>
                        <div class="relative">
                ...
                <!-- <?= lang('App.email_address') ?> -->
                <div class="space-y-1.5">
                    <label class="block text-sm font-bold text-textMain"><?= lang('App.email_address') ?></label>
                    <div class="relative">
                ...
                <!-- <?= lang('App.password') ?> -->
                <div class="space-y-1.5">
                    <label class="block text-sm font-bold text-textMain"><?= lang('App.password') ?></label>
                    <div class="relative" x-data="{ show: false }">
                        <i data-lucide="lock" class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-textMuted"></i>
                        <input type="password" :type="show ? 'text' : 'password'" placeholder="<?= lang('App.signup_password_placeholder') ?>" class="w-full pl-11 pr-12 py-3.5 bg-background border border-borderBase rounded-xl focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all text-textMain font-medium">
                ...
                <p class="text-xs text-textMuted pt-2">
                    <?= lang('App.signup_terms_prefix') ?> <a href="#" class="text-primary hover:underline"><?= lang('App.signup_terms_service') ?></a> <?= lang('App.signup_and') ?> <a href="#" class="text-primary hover:underline"><?= lang('App.signup_privacy_policy') ?></a>.
                </p>
                ...
                <button type="submit" class="w-full py-4 mt-4 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition-all shadow-lg shadow-primary/30 flex items-center justify-center gap-2">
                    <?= lang('App.signup_create_account_button') ?> <i data-lucide="arrow-right" class="w-5 h-5"></i>
                </button>

            </form>

            <div class="mt-8 text-center text-sm font-medium text-textMuted">
                <?= lang('App.already_have_account') ?> <a href="<?= base_url('login') ?>" class="text-primary font-bold hover:underline"><?= lang('App.signup_sign_in_instead') ?></a>
            </div>
