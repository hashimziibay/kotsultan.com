 ...
 */
?>
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700/80 overflow-hidden shadow-xs hover:shadow-md transition-all duration-200 transform hover:-translate-y-1 flex flex-col justify-between group">
    <div>
        <!-- Photo Header -->
    ...
    <div class="p-5 pt-0 grid grid-cols-2 gap-2 mt-4 border-t border-slate-100 dark:border-slate-700/60 pt-4">
